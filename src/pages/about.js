...
const About = () => {
    ...
    }, [window.innerWidth, window.innerHeight]); // Make sure the effect runs only once
...
//         animated.brightness.current = first ? 1 : map(mouseDistanceX,0,100,1,4);
//
//
...
//         animated.brightness.previous = first ? animated.brightness.current : lerp(animated.brightness.previous, animated.brightness.current, animated.brightness.amt);
//
//
//         gsap.set(".profile", {
...
//             filter: `brightness(${animated.brightness.previous})`,
//             stagger: -0.05,
