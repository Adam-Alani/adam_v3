...
const Archives = () => {
    ...
    return (
        <div className="px-8 border-t-4 border-white bg-dark font-Work-Sans">
            <h1 className="font-black text-7xl sm:text-8xl md:text-9xl">ARCHIVES</h1>
            <div className="py-16">
                        ...
                        <div className="md:w-2/3">
                            <a target="_blank" rel="noopener" href={repo.html_url}  className="py-1 border-b-2 group  border-dotted transition duration-500 ease-in-out transform flex flex-row  justify-between">
                                <div>
                                    ...
                                    <p className="hidden md:block pr-8 pb-2 text-sm text-gray-300 select-none overflow-ellipsis font-light  transition group-hover:text-primary duration-75">{(repo.description)}</p>
                                </div>
                                <div className="text-right pt-2 items-start flex flex-row float-right">
                                    <div className="pr-4">
                                        ...
                                        <p className="hidden md:block  text-initial select-none  transition group-hover:text-primary duration-75">{(repo.language)}</p>
                                    </div>
